...
const models = [
  { name: 'scene', file: 'scene.gltf', type: 'glb', path: '/src/assets/scene.gltf' },
...
const availableObjects = [
  { name: 'scene', file: 'dog.glb', path: '/src/assets/scene.gltf' },
...
onMounted(() => {
  ...
  // Use window size for camera aspect and renderer size
...
<template>
  <div style="position: relative; width: 100vw; height: 100vh; margin: 0; padding: 0; overflow: hidden;">
    <canvas ref="canvasRef" style="width: 100vw; height: 100vh; display: block; background: #222233; cursor: pointer;"></canvas>
